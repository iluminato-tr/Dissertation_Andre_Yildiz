...
###Loading Data files
```{r}
load(file="~/Desktop/BRCA_project/Data/BRCA_mrna.RData") #BRCA mRNA
load(file="~/Desktop/BRCA_project/Data/BRCA_mirna.RData") #BRCA miRNA
load(file="~/Desktop/BRCA_project/Data/BRCA_proteome.RData") #BRCA proteome
load(file="~/Desktop/BRCA_project/Data/BRCA_meth.RData") #BRCA methylation beta value
load(file="~/Desktop/BRCA_project/Data/df_vecs.RData") #BRCA Tumor or not 
load(file="~/Desktop/BRCA_project/Data/subtype.RData") #BRCA subtype file
```
...
### Step 2: Preprocessing Methylation Data 
```{r}
...
cpg_map <- read.csv("~/Desktop/BRCA_project/CPG_ProbeData/infinium-methylationepic-v-1-0-b5-manifest-file.csv",header=TRUE, skip=3)
...
```
###step5: Final processes, mRNA annotation, and file saving
```{r}
df <- as.data.frame(filtered_df_vecs4)
df <- df %>% arrange(barcode)
write.csv(df, file = "~/Desktop/BRCA_project/Processed/BRCA_df_processed.csv")

df <- mrna_multimodal_processing
df <- df[,-1]
...
load(file = "~/Desktop/BRCA_project/Data/subtype.RData")
df =read.csv(file= "~/Desktop/BRCA_project/Processed/BRCA_df_processed.csv" )
...
write.csv(df_merged, file= "~/Desktop/BRCA_project/Processed/Multi_code.csv")
...
write.csv(meth_filtered,file = "~/Desktop/BRCA_project/Processed/BRCA_meth_processed.csv")
write.csv(mymat, file = "~/Desktop/BRCA_project/Processed/BRCA_mRNA_annotated.csv")
write.csv(miRNA_filtered, file = "~/Desktop/BRCA_project/Processed/BRCA_mirna_processed.csv")
write.csv(proteome_processing, file = "~/Desktop/BRCA_project/Processed/BRCA_proteome_processed.csv")
write.csv(df_cleaned, file= "~/Desktop/BRCA_project/Processed/Multi_code.csv")
```
